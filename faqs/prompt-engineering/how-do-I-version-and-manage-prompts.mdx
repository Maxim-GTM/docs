...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "FAQPage",
      "name": "How do I Version and Manage Prompts?",
      "mainEntity": {
        "@type": "Question",
        "name": "How do I Version and Manage Prompts?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Maxim's Prompt Playground provides a complete environment for creating, versioning, comparing, and deploying prompts, all without making any changes to the existing code base."
        }
      }
    })
  }}
